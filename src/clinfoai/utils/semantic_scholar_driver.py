...
class SemanticScholarAPI:
    ...
    def search(self, query, verbose=False):
        ...
        headers = {
            ...
            "x-api-key": "a0Z1F23s6o3iGu3d8C3aA6cbEtn7Kr2naY5fWyDo",
        }
    ...
    def filter_papers(
        self, papers, threshold=5, minimum_return=5, maxmum_return=15, verbose=False
    ):
        filtered_papers = []
        for paper in papers:
        ...
        if verbose:
            print(
                f"Filtered {len(papers)} papers down to {len(filtered_papers)} influential papers with at least {threshold} influential citations."
            )
    ...
    def search_with_filter(
        self, query, threshold=1, minimum_return=5, maxmum_return=15, verbose=False
    ):
